        ...
        $row = 2;
            foreach($products as $product){
                ...
                if(is_null($product->picture)){
                    $drawing->setPath(public_path('/hosting/php820/appchin/storage/app/vacio.jpg'));
                }else{
                    $drawing->setPath(public_path('/hosting/php820/appchin/storage/app'.$product->picture));
                }
                $drawing->setWidth(90);
