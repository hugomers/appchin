        ...
        $products = Product::where('_download',0)->get();
            ...
            foreach($products as $product){
                ...
                if(is_null($product->picture)){
                    $firstdrawing->setPath('/home/u665966195/domains/grupovizcarra.mx/public_html/apimport/storage/app/public/vacio.jpg');
                    // $firstdrawing->setPath('C:/laragon/www/appchin/storage/app/vacio.jpg');
                }else{
                    $firstdrawing->setPath('/home/u665966195/domains/grupovizcarra.mx/public_html/apimport/storage/app/public'.$product->picture);
                ...
                if(is_null($product->provider)){
                    $secondrawing->setPath('/home/u665966195/domains/grupovizcarra.mx/public_html/apimport/storage/app/public/vacio.jpg');
                    // $secondrawing->setPath('C:/laragon/www/appchin/storage/app/vacio.jpg');
                }else{
                    $secondrawing->setPath('/home/u665966195/domains/grupovizcarra.mx/public_html/apimport/storage/app/public'.$product->provider);
